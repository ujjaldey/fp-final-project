...
import fpfinal.common.Validations.nonNegative
...
class Money private(_cents: Int) {
  ...
  /**
   * TODONE #6: Implement division by an integer. When n is 0, the result should be None.
...
object Money {
  ...
  /**
   * TODONE #7: Create a validated Money object that represents this dollars amount.
  ...
  /**
   * TODONE #4: Implement and instance of Order for Money that compares its cents.
