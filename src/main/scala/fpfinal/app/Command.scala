...
object AddExpenseCommand extends Command {
  ...
  def execute(): AppOp[SuccessMsg] = {
    ...
    /**
      * TODONE #26: Implement a function that reads participant names from console until the
      * user enters END to finish.
      *
      * Extra points: implement it using ME.tailRecM
      */
    def readParticipants(): AppOp[List[String]] = {
      val msg = s"Enter name of participants or END to finish):"
    ...
    /**
      * TODONE #27: Use the helper functions in common.Validations and return a validated
    ...
    /**
      * TODONE #28: Implement a function that finds a person by name.
      *
...
case object AddPersonCommand extends Command {
  ...
  override def execute(): AppOp[SuccessMsg] = {
    ...
    /**
      * TODONE #29: Use readData() to read person data from console and use it to add a
